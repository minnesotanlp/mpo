...
def get_task_dataset(task_name: str, tokenizer, split: str):
    ...
    from trl.extras import mpogrpo
    ...
    if task_name == "essay_writing":
        ...
        data_file_path = os.path.join(os.path.dirname(mpogrpo.__file__), "corpora", "MATH", corpus_filename)
        ...
        data_file_path = os.path.join(os.path.dirname(mpogrpo.__file__), "corpora", "anecdotes", corpus_filename)
...
def get_reward_model(task_name: str, reward_model_address: str, experiment_directory: str, **kwargs):
    ...
    """
    from trl.extras.mpogrpo.rm_essay_writing import RewardModelEssayWriting
    from trl.extras.mpogrpo.rm_ethical_reasoning import RewardModelEthicalReasoning
    from trl.extras.mpogrpo.rm_math_reasoning import RewardModelMathReasoning
    from trl.extras.mpogrpo.rm_summarization import RewardModelSummarization
...
def get_meta_reward_model(task_name: str, reward_model_address: str, experiment_directory: str, **kwargs):
    ...
    """
    from trl.extras.mpogrpo.rm_essay_writing import MetaRewardModelEssayWriting
    from trl.extras.mpogrpo.rm_ethical_reasoning import MetaRewardModelEthicalReasoning
    from trl.extras.mpogrpo.rm_math_reasoning import MetaRewardModelMathReasoning
    from trl.extras.mpogrpo.rm_summarization import MetaRewardModelSummarization
