...
def get_task_dataset(task_name: str, tokenizer, split: str):
    ...
    if task_name == "essay_writing":
        ...
        data_file_path = os.path.join(os.path.dirname(mpoppo.__file__), "corpora", "MATH", corpus_filename)
        ...
        data_file_path = os.path.join(os.path.dirname(mpoppo.__file__), "corpora", "anecdotes", corpus_filename)
