...
from trl import ModelConfig, MPOGRPOConfig, MPOGRPOTrainer, ScriptArguments, get_kbit_device_map, get_quantization_config
from trl.extras.mpogrpo import get_task_dataset
from trl.trainer.utils import SIMPLE_CHAT_TEMPLATE


"""
See launch script in scripts/mpogrpo_experiments/launch_mpogrpo.sh
"""
...
if __name__ == "__main__":
    ...
    seed_everything(42)
    parser = HfArgumentParser((ScriptArguments, MPOGRPOConfig, ModelConfig))
