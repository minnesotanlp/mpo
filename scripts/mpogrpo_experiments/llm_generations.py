...
from trl.trainer.utils import SIMPLE_CHAT_TEMPLATE, MPOGRPODataCollatorWithPadding, generate


"""Example
accelerate launch --config_file examples/accelerate_configs/multi_gpu_4gpus.yaml scripts/mpogrpo_experiments/llm_generations.py \
...
if __name__ == "__main__":
    ...
    dataloader = DataLoader(
        ...
        collate_fn=MPOGRPODataCollatorWithPadding(tokenizer),
        drop_last=False,
    )
